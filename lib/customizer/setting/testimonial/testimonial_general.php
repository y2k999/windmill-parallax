	...
	*/
	beans_add_smart_action('customize_register',function($wp_customize)
	{
		...
		*/
		...
		// headline_section_testimonial
		$wp_customize->add_setting('setting_WP_headline_section_testimonial',array(
			'default' => __get_customizer_default_child('headline_section_testimonial'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_text'
		));
		$wp_customize->add_control('setting_WP_headline_section_testimonial',array(
			'settings' => 'setting_WP_headline_section_testimonial',
			'label' => esc_html__('Section Headline','windmill'),
			'section' => 'section_WP_' . $_section,
			'type' => 'text',
		));

		// slideshow_speed_testimonial
		$wp_customize->add_setting('setting_WP_slideshow_speed_testimonial',array(
			'default' => __get_customizer_default_child('slideshow_speed_testimonial'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_number',
		));
		$wp_customize->add_control('setting_WP_slideshow_speed_testimonial',array(
			'settings' => 'setting_WP_slideshow_speed_testimonial',
		...
		// slideshow_autoplay_testimonial
		$wp_customize->add_setting('setting_WP_slideshow_autoplay_testimonial',array(
			'default' => __get_customizer_default_child('slideshow_autoplay_testimonial'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_checkbox',
		));
		$wp_customize->add_control('setting_WP_slideshow_autoplay_testimonial',array(
			'settings' => 'setting_WP_slideshow_autoplay_testimonial',
