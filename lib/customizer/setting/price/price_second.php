	...
	*/
	beans_add_smart_action('customize_register',function($wp_customize)
	{
		...
		*/
		...
		// price_second_price
		$wp_customize->add_setting('setting_WP_price_second_price',array(
			'default' => __get_customizer_default_child('price_second_price'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_number',
		));
		$wp_customize->add_control('setting_WP_price_second_price',array(
			'settings' => 'setting_WP_price_second_price',
		...
		// included_second_price
		$wp_customize->add_setting('setting_WP_included_second_price',array(
			'default' => __get_customizer_default_child('included_second_price'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_text_field',
		));
		$wp_customize->add_control('setting_WP_included_second_price',array(
			'settings' => 'setting_WP_included_second_price',
		...
		// storage_second_price
		$wp_customize->add_setting('setting_WP_storage_second_price',array(
			'default' => __get_customizer_default_child('storage_second_price'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_number',
		));
		$wp_customize->add_control('setting_WP_storage_second_price',array(
			'settings' => 'setting_WP_storage_second_price',
		...
		// support_second_price
		$wp_customize->add_setting('setting_WP_support_second_price',array(
			'default' => __get_customizer_default_child('support_second_price'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_text_field',
		));
		$wp_customize->add_control('setting_WP_support_second_price',array(
			'settings' => 'setting_WP_support_second_price',
		...
		// description_first_price
		$wp_customize->add_setting('setting_WP_description_second_price',array(
			'default' => __get_customizer_default_child('description_second_price'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_textarea'
		));
		$wp_customize->add_control('setting_WP_description_second_price', array(
			'settings' => 'setting_WP_description_second_price',
