	...
	*/
	beans_add_smart_action('customize_register',function($wp_customize)
	{
		...
		*/
		...
		// price_first_price
		$wp_customize->add_setting('setting_WP_price_first_price',array(
			'default' => __get_customizer_default_child('price_first_price'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_number',
		));
		$wp_customize->add_control('setting_WP_price_first_price',array(
			'settings' => 'setting_WP_price_first_price',
		...
		// included_first_price
		$wp_customize->add_setting('setting_WP_included_first_price',array(
			'default' => __get_customizer_default_child('included_first_price'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_text_field',
		));
		$wp_customize->add_control('setting_WP_included_first_price',array(
			'settings' => 'setting_WP_included_first_price',
		...
		// storage_first_price
		$wp_customize->add_setting('setting_WP_storage_first_price',array(
			'default' => __get_customizer_default_child('storage_first_price'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_number',
		));
		$wp_customize->add_control('setting_WP_storage_first_price',array(
			'settings' => 'setting_WP_storage_first_price',
		...
		// support_first_price
		$wp_customize->add_setting('setting_WP_support_first_price',array(
			'default' => __get_customizer_default_child('support_first_price'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_text_field',
		));
		$wp_customize->add_control('setting_WP_support_first_price',array(
			'settings' => 'setting_WP_support_first_price',
		...
		$wp_customize->add_setting('setting_WP_description_first_price',array(
			'default' => __get_customizer_default_child('description_first_price'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_textarea'
		));
		$wp_customize->add_control('setting_WP_description_first_price', array(
			'settings' => 'setting_WP_description_first_price',
