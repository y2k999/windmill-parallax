	...
	*/
	beans_add_smart_action('customize_register',function($wp_customize)
	{
		...
		*/
		...
		// headline_section_blog
		$wp_customize->add_setting('setting_WP_headline_section_blog',array(
			'default' => __get_customizer_default_child('headline_section_blog'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_text'
		));
		$wp_customize->add_control('setting_WP_headline_section_blog',array(
			'settings' => 'setting_WP_headline_section_blog',
			'label' => esc_html__('Section Headline','windmill'),
			'section' => 'section_WP_' . $_section,
			 'type' => 'text',
		));

		// description_section_blog
		$wp_customize->add_setting('setting_WP_description_section_blog',array(
			'default' => __get_customizer_default_child('description_section_blog'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_textarea'
		));
		$wp_customize->add_control('setting_WP_description_section_blog', array(
			'settings' => 'setting_WP_description_section_blog',
			'label' => esc_html__('Section Description','windmill'),
			'section' => 'section_WP_' . $_section,
			'type' => 'textarea',
		));

		// scrollspy_speed_blog
		$wp_customize->add_setting('setting_WP_scrollspy_speed_blog',array(
			'default' => __get_customizer_default_child('scrollspy_speed_blog'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_number',
		));
		$wp_customize->add_control('setting_WP_scrollspy_speed_blog',array(
			'settings' => 'setting_WP_scrollspy_speed_blog',
		...
		// scrollspy_effect_blog
		$wp_customize->add_setting('setting_WP_scrollspy_effect_blog',array(
			'default' => __get_customizer_default_child('scrollspy_effect_blog'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_text_field',
		));
		$wp_customize->add_control('setting_WP_scrollspy_effect_blog',array(
			'settings' => 'setting_WP_scrollspy_effect_blog',
		...
		// scrollspy_direction_blog
		$wp_customize->add_setting('setting_WP_scrollspy_direction_blog',array(
			'default' => __get_customizer_default_child('scrollspy_direction_blog'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_text_field',
		));
		$wp_customize->add_control('setting_WP_scrollspy_direction_blog',array(
			'settings' => 'setting_WP_scrollspy_direction_blog',
			'label' => esc_html__('Scrollspy Effect','windmill'),
			'section' => 'section_WP_' . $_section,
			'type'		=> 'select',
			'choices' => array(
