	...
	*/
	beans_add_smart_action('customize_register',function($wp_customize)
	{
		...
		*/
		...
		$wp_customize->add_setting('setting_WP_headline_section_team',array(
			'default' => __get_customizer_default_child('headline_section_team'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_text'
		));
		$wp_customize->add_control('setting_WP_headline_section_team',array(
			'settings' => 'setting_WP_headline_section_team',
			'label' => esc_html__('Section Headline','windmill'),
			'section' => 'section_WP_' . $_section,
			 'type' => 'text',
		));

		// description_section_team
		$wp_customize->add_setting('setting_WP_description_section_team',array(
			'default' => __get_customizer_default_child('description_section_team'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_textarea'
		));
		$wp_customize->add_control('setting_WP_description_section_team', array(
			'settings' => 'setting_WP_description_section_team',
			'label' => esc_html__('Section Description','windmill'),
			'section' => 'section_WP_' . $_section,
			'type' => 'textarea',
		));

		// scrollspy_speed_team
		$wp_customize->add_setting('setting_WP_scrollspy_speed_team',array(
			'default' => __get_customizer_default_child('scrollspy_speed_team'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_number',
		));
		$wp_customize->add_control('setting_WP_scrollspy_speed_team',array(
			'settings' => 'setting_WP_scrollspy_speed_team',
		...
		// scrollspy_effect_team
		$wp_customize->add_setting('setting_WP_scrollspy_effect_team',array(
			'default' => __get_customizer_default_child('scrollspy_effect_team'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_text_field',
		));
		$wp_customize->add_control('setting_WP_scrollspy_effect_team',array(
			'settings' => 'setting_WP_scrollspy_effect_team',
		...
		// scrollspy_direction_team
		$wp_customize->add_setting('setting_WP_scrollspy_direction_team',array(
			'default' => __get_customizer_default_child('scrollspy_direction_team'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => 'sanitize_text_field',
		));
		$wp_customize->add_control('setting_WP_scrollspy_direction_team',array(
			'settings' => 'setting_WP_scrollspy_direction_team',
			'label' => esc_html__('Scrollspy Effect','windmill'),
			'section' => 'section_WP_' . $_section,
			'type'		=> 'select',
			'choices' => array(
