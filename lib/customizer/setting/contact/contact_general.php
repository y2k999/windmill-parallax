	...
	*/
	beans_add_smart_action('customize_register',function($wp_customize)
	{
		...
		*/
		...
		// shortcode_contact
		$wp_customize->add_setting('setting_WP_shortcode_contact',array(
			'default' => __get_customizer_default_child('shortcode_contact'),
			'capability' => 'edit_theme_options',
			'sanitize_callback' => '__utility_sanitize_text'
		));
		$wp_customize->add_control('setting_WP_shortcode_contact',array(
			'settings' => 'setting_WP_shortcode_contact',
