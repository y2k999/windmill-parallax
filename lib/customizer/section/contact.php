...
<?php
	 ...
	 * @return (array)
	*/
	if(function_exists('__get_section_child_contact') === FALSE) :
	function __get_section_child_contact()
	{
		return array(
			'contact_general' => esc_html__('General Settings','windmill'),
		);
	...
	*/
	beans_add_smart_action('customize_register',function($wp_customize)
	{
		...
		foreach(__get_section_child_contact() as $key => $value){
			/**
			 * [NOTE]
